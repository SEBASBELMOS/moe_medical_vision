...
CKPT_OUT = Path('/workspace/moe_medical_vision/checkpoints/expert4_luna16_2p5d_convnext_best.pth')
...
class Luna2p5DFast(Dataset):
    def __init__(self, root, split='train'):
        ...
        self.split=split
        print(f'[LUNA 2P5D ConvNeXt {split}] {len(self.files)} | neg={counts[0]} pos={counts[1]}')
...
for epoch in range(1,13):
    ...
    if row['val_f1']>best:
        ...
        if wait>=6:
            ...
            break
print(f"LUNA 2P5D ConvNeXt: best_val_f1={best:.4f} best_epoch={best_epoch}")
print('DONE')
