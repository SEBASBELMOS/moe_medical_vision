"""
LUNA FINAL A: R3D-18 fine-tune from v1 baseline.
Heavy regularization + balanced sampling + 30 epochs + patience=15.
...
CKPT = CHECKPOINT_DIR / 'expert4_luna16_FINAL_A_best.pth'

print('='*80)
print('LUNA FINAL A: R3D-18 fine-tune from v1, heavy reg, 30ep')
print('='*80)
...
# Replace head with stronger regularization
...
print(f'FINAL_A: best_val_f1={result["best_val_f1"]:.4f} best_epoch={result["best_epoch"]}')
print('DONE_A')
