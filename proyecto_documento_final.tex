...
\begin{table}[H]
\centering
\caption{Chequeo end-to-end APP-aligned del sistema integrado (50 muestras, 10 por dominio). Se reporta el routing del sistema completo y el F1 del experto invocado.}
\label{tab:e2e}
\footnotesize
\begin{tabular}{lccc}
\toprule
\textbf{Dominio} & \textbf{Router Acc.} & \textbf{F1 Expert} & \textbf{Observación} \\
\midrule
NIH            & 0.70 & 0.20 & cuello residual del Experto 1 \\
ISIC 2019      & 1.00 & 0.55 & experto ya funcional tras corregir backbone timm \\
Osteoarthritis & 0.80 & 0.69 & comportamiento estable \\
LUNA16         & 1.00 & 1.00 & comportamiento estable en la muestra APP-aligned \\
Pancreatic     & 1.00 & 0.44 & routing estabilizado con sub-router 3D \\
\midrule
\multicolumn{3}{r}{\textbf{Routing global del sistema}} & \textbf{0.90} \\
\bottomrule
\end{tabular}
\end{table}
