...
\midrule
NIH            & 0.80 & 0.10 & cuello residual del Experto 1 \\
ISIC 2019      & 0.90 & 0.00 & routing correcto; revisar calibración del experto \\
Osteoarthritis & 1.00 & 0.57 & comportamiento estable \\
LUNA16         & 1.00 & 0.80 & comportamiento estable \\
Pancreatic     & 1.00 & 0.41 & routing estabilizado con sub-router 3D \\
\midrule
\multicolumn{3}{r}{\textbf{Routing global del sistema}} & \textbf{0.88} \\
\bottomrule
\end{tabular}
\end{table}
